...
describe('CancelBookingComponent', () => {
  ...
  let mockCancelBookingService;
  let mockDataService

  beforeEach(async(() => {

    mockCancelBookingService = sinon.createStubInstance(CancelBookingService);
    mockCancelBookingService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CancelBookingService, useValue: mockCancelBookingService },
